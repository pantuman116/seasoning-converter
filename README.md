...
## パッケージ、クラス
* framework: 単位変換の考え方を表すためのインターフェースクラスをまとめている。
* unit/volume: 体積の単位となるクラス及び、体積単位クラスのオブジェクトを生成するクラスをまとめている。新しい体積単位を増やす場合は、Volumeクラスをインターフェースとした新規クラスを作成する。
* unit/weight: 重量の単位となるクラス及び、重量単位クラスのオブジェクトを生成するクラスをまとめている。新しい重量単位を増やす場合は、Weightクラスをインターフェースとした新規クラスを作成する。
* converter: 単位変換を行うクラスをまとめている。
* 
<details>
